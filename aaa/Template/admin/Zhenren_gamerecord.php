...
<div class="page-container">
    <form method="get" action="{:U('gamerecord','game_type='.$game_type)}" class="text-c">
        下注时间:<input class="input-text" type="text" style="width:180px;" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"
                    name="sDate" value="{$_sDate}"> -
        <input class="input-text" type="text" style="width:180px;" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"
               value="{$_eDate}" name="eDate">
        用户名：<input class="input-text" type="text" value="{$username}" name="username" style="width:180px">
        <a class="btn btn-default-outline radius" href="{:U('gamerecord','game_type='.$game_type)}">重置</a>

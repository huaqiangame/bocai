        ...
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tbody>
                ...
                <tr class="text-c warning">
                    <td>页面小计</td>
                    <td>{$zongji.zdchongzhiall}</td>
                    <td>{$zongji.sdjiachongzhiall}</td>
                    <td>{$zongji.sdjianchongzhiall}</td>
                    <td>{$zongji.tikuanall}</td>
                     <td>{$zongji.ctyingkui}</td>
                   <td>{$zongji.touzhuall}</td>
                    <td>{$zongji.zhongjiangall}</td>
                    <td>{$zongji.huodongall}</td>
                    <td>{$zongji.tzyingkui}</td>
                    <td>~~~</td>
                </tr>
            </tbody>
        </table>

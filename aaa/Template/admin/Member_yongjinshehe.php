...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal validate-form" id="AjaxPostForm">
        ...
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">代理名称：</label>
        ...
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">投注金额：</label>
			<div class="formControls col-xs-8 col-sm-9">
				{$info.touzhujine}
			</div>
		</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">佣金金额：</label>
			<div class="formControls col-xs-8 col-sm-9">
				{$info.amount} 元
			</div>
		</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>佣金状态：</label>

...
<a href="javascript:;" layer-url="{:U('add')}" title="添加会员组" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加会员组</a>&nbsp;&nbsp;&nbsp;
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
            ...
            <tr class="text-c">
				...
				<td>{$vo.touhan}</td>
                <td><u style="cursor:pointer" class="text-primary" layer-url="{:U('setxiane',['id'=>$vo['groupid']])}" title="限额设置-{$vo.groupname}">限额设置</u></td>
				<td class="td-manage">

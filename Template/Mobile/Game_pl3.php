...
<header data-am-widget="header" class="am-header am-header-default header am-header-fixed" >
      ...
      <div class="am-header-right am-header-nav" style="top: 14px;">
		 ...
		 <div class="newcode">
            <div style="float: left;margin-left: 1.5em;font-size:15px;" id="my_tz">我的投注<div class="activetz"></div></div>
            <div style="float: left;margin-left: 1.5em;font-size:15px;color:#999999;"  id="tz_jl">投注记录<div ></div></div>
        ...
        <div class="tz_read">
            <table border="0" class="newtable">
                <tr>
                    <th style="color: #fff;text-align: center;width: 30%">投注单号</th>

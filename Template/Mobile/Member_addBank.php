			...
			<ul class="bank_form_list">
				<li class="am-cf">
					...
					<!--<div class="am-fr bank_right_input">
						<input type="text"  id="accountname" name="accountname"  class="input_txt" placeholder="技术支持QQ:33723247【禁止非法运营赌博，谁充值赌博谁傻逼】" >
					</div>-->
...
<!--				<li class="am-cf">
				...
				<li class="am-cf">
					...
					<div class="am-fr bank_right_input">
						<input type="password" id="bankTradPwd" name="safepass"  class="input_txt" placeholder="请输入您的提款密码">
					</div>
				</li>
			</ul>
	...
	<script>
		var userbindbankcard = function(){
			...
			if (bankCode.length < 1) {
				...
				alert("技术支持QQ:33723247【禁止非法运营赌博，谁充值赌博谁傻逼】");return false;

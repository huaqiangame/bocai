...
<header data-am-widget="header" class="am-header am-header-default header nav_bg am-header-fixed">
      ...
      <h1 class="am-header-title userHome_h1" style="width: 100%;">
		...
		<ul class="yGame_list">
		 ...
		 <div class="newcode" style="  background: linear-gradient(#ce3041,#90121c);">
  ...
  <div class="page-group">
	<div class="open_containers g_Time_Section">
        <!--彩种开奖倒计时-->
        <div class="cz_daojishi" style="float:none;height:60px;width: 100%;border:none;">
    ...
    <section id="gameBet" class="cl">
		<section class="gameBet_balls">
			...
			<if condition="$nowcpinfo['iswh'] eq 0">
				...
				<!--玩法详细说明区域-->
				<div class="play_select_prompt_old" >
					<i class="iconfont c_org"></i>
					<span way-data="tabDoc"></span>
				</div>
				<div class="sliderConter" style="background:none">
...
<div class="sscFooter  active">
				...
				<div class="numberLan" style="display: none;">
					<header data-am-widget="header" class="am-haomalan am-header-default header nav_bg am-header-fixed am-no-layout">
						...
						<div class="xiad-left" style="margin-top:3px; ">
...
$("#tz_jl").click(function () {
	...
	$(document).on('click','.am-header-left',function (){
		$('.numberLan').hide();

...
<!--<script src="__JS2__/require.js" data-main="__JS2__/homePage">
    ...
    <header data-am-widget="header" class="am-header am-header-default header am-header-fixed" >
      ...
      <div class="play_select_insert" id="j_play_select">
          <ul class="play_select_tit" style="overflow:hidden;margin-top:75px;">
              <if condition="$lotteryname != 'txssc'">
				...
				<li lottery_code="1x" class="curr">一星</li>
...
<li><label for="answer1" class="ui-label">投注号码：</label><span class="textarea" way-data="BillInfo.tzcode">--</span>
</li>	

...
<link rel="stylesheet" href="__ROOT__/Template/Mobile/css/ssc_kl8.css">
<script>
var WebConfigs = {
...
<!--技术支持QQ:33723247【禁止非法运营赌博，谁充值赌博谁傻逼】<script src="__JS2__/require.js" data-main="__JS2__/homePage"></script>
...
<header data-am-widget="header" class="am-header am-header-default header  am-header-fixed" >
	...
	<div class="open_containers g_Time_Section">
        <!--彩种开奖倒计时-->
       <div class="cz_daojishi" style="float:none;height:60px;width: 100%;">
            <div class="open_issue" style="font-size:1.3em;line-height:2em;">
				<span class="c_red" id="f_lottery_info_number" way-data="showExpect.currFullExpect">---</span>期投注截至--<span way-data="gametimes.h" style="color:#dc3b40;">00</span>:<span way-data="gametimes.m" style="color:#dc3b40;">00</span>:<span way-data="gametimes.s" style="color:#dc3b40;">00</span>
            	 ...
            	 <i class="iconfont icon-jiantouxia" style="line-height:
				 .75em;height:.9em;border-top-right-radius:0;border-top-left-radius:0;
				 border-radius:.3em;
			 border:1px solid #bdb58b; color:#d3cdaf;width:4.8em;margin: 0 auto; display:block;
				 background:#f5f1e5;"></i>				
         </div>
        <!--彩种开奖倒计时-->
						...
						<tr>
							<td style="position: relative;">
								<div class="peilu tebie">
									<var style="color: rgb(202, 202, 202);">奖金</var>
									<span id="amount">
										47.628
          ...
          <div class="selectMultipleB addtobetbtn">
            ...
            <span class="selectMultipleOld">
              ...
              元
				...
				<!--玩法详细说明区域-->
				<div class="numberLan" style="display: none;" style="height: auto;">

...
<form class="am-form register_form" method="post" url="" checkby_ruivalidate id="register_form" onSubmit="return checkform(this)">
                ...
                <div class="ui-form-item ui-border-b">
					...
					<if condition="$rpassword eq ''">
						<span><p style="color: black; display:inline">请先设置<a style="padding: 5px 5px; color: red;" href="{:U('User/safepass')}">提款密码</a></p></span>
					<else />
						<input type="password" name="pass" isnot="true" msg="请填写提款密码">
					</if>
                </div> 

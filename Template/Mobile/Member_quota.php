<!DOCTYPE html>
<html lang="zh">
    <link type="text/css" rel="stylesheet" href="__CSS__/css2/font-awesome.min.css">
    <link type="text/css" rel="stylesheet" href="__CSS__/css2/mmenu.all.css">
    <link type="text/css" rel="stylesheet" href="__CSS__/css2/ssc.css">
    <link type="text/css" rel="stylesheet" href="__CSS__/css2/member.css">
    <link type="text/css" rel="stylesheet" href="__CSS__/icon.css">
    <link type="text/css" rel="stylesheet" href="__CSS__/moneychange.css">
    <script type="text/javascript" src="__JS__/js2/mmenu.all.min.js"></script>
    <script type="text/javascript" src="__JS__/js2/member.js"></script>
	<script type="text/javascript" src="__JS__/js2/iconfont.js"></script>
		...
		<div class="pull-right vip_info_pan">
			...
			<div class="vip_info_content betRecord_main">
				<div class="betRecord_top">
					<span>帐户余额：<em>{$balance}元</em></span><br>
					<span>AG--余额：<em ><i class="ag">{$agBalance}</i>元</em></span><br>
					<span>BBIN余额：<em ><i class="bbin">{$bbBalance}</i>元</em></span><br>
					<span>体育余额：<em ><i class="ss">{$ssBalance}</i>元</em></span><br>					
					<span>开元余额：<em ><i class="ky">{$kyBalance}</i>元</em></span><br>
				</div>
					...
					<div class="category >
						...
						<div class="form-group">
							<select name="quota_type" id="quota_type"  class="form-control" id="" style="width:150px">
								...
								<option value="3">主账号至BBIN</option>	
								<option value="5">主账号至体育</option> 								
								<option value="7">主账号至开元</option> 
								<option value="2">AG至主账号</option> 								
								<option value="4">BBIN至主账号</option> 
								<option value="6">体育至主账号</option> 								

$(function(){
	...
	$(document).on('click','.prompt-usereditdrawpass', function () {
      $.modal({
            title: '修改提款密码',
            text: '<input class="modal-text-input" type="password" placeholder="旧提款密码" id="usereditdrawpass_oldpassword"><input class="modal-text-input" type="password" placeholder="新提款密码" id="usereditdrawpass_password"><input class="modal-text-input" type="password" placeholder="确认密码" id="usereditdrawpass_rpassword">',
            buttons: [ 
				{text: '取消'},
				{text: '确定',bold: true, onClick: function(){
	...
	$(document).on('click','.prompt-bindrealname', function () {
      $.modal({
            title: '绑定真实姓名',
            text: '<input class="modal-text-input" type="text" placeholder="真实姓名" id="bindrealname_realname"><input class="modal-text-input" type="password" placeholder="提款密码" id="bindrealname_tradepassword">',
            buttons: [ 
				{text: '取消'},
				{text: '确定',bold: true, onClick: function(){
	...
	$(document).on('click','.prompt-bindphone', function () {
      $.modal({
            title: '绑定手机号码',
            text: '<input class="modal-text-input" type="text" placeholder="手机号码" id="bindphone"><input class="modal-text-input" type="password" placeholder="提款密码" id="phonetradePwd">',
            buttons: [ 
				{text: '取消'},
				{text: '确定',bold: true, onClick: function(){
	...
	$(document).on('click','.prompt-bindemail', function () {
      $.modal({
            title: '绑定邮箱',
            text: '<input class="modal-text-input" type="text" placeholder="邮箱账号" id="bindemail"><input class="modal-text-input" type="password" placeholder="提款密码" id="emailtradePwd">',
            buttons: [ 
				{text: '取消'},
				{text: '确定',bold: true, onClick: function(){
...
//密保
	...
	function setmibao(){
		...
		texth += '<input id="tradePwd" class="modal-text-input" value="" type="password" placeholder="提款密码">';
...
function bindcard(){
	...
	html += '<input class="modal-text-input" type="password" placeholder="提款密码" id="bankTradPwd">';

            ...
            if (msg.sign == true) {
                if (msg.data.opencode.length > 0) {
                    ...
                    if (lastExpect == openexpect) {
                        ...
                        var yopentimes_arr = yopentimes.split(' ');
                        var yopentime = yopentimes_arr[1];
                        var html = '<tr><td class="lsqh">' + openexpect + '</td><td style="background-image:-webkit-linear-gradient(0deg,#bdb48b,#bdb48b 0.3%,transparent 0);color:red;" class="c_red fb';
                        html += '">';

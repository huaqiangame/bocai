...
<!--		<div class="winners_tab am-header-title">
		...
		<h1 class="am-header-title userHome_h1">游戏记录</h1>		
	...
	<div data-am-widget="tabs" class=" am-tabs-d2 billrecord_main">
		<ul class="am-tabs-nav am-cf">
			<li <if condition="$Think.get.a_item eq '1'">class="am-active"</if>><a href="{:U('Member/betRecord',array('a_item'=>1))}">真人视讯</a></li>
			<li <if condition="$Think.get.a_item eq '2'">class="am-active"</if>><a href="{:U('Member/betRecord',array('a_item'=>2))}">电子游艺</a></li>
			<li <if condition="$Think.get.a_item eq '3'">class="am-active"</if>><a href="{:U('Member/betRecord',array('a_item'=>3))}">VR彩票</a></li>
			<li <if condition="$Think.get.a_item eq '4'">class="am-active"</if>><a href="{:U('Member/betRecord',array('a_item'=>4))}">体育投注</a></li>
		</ul>

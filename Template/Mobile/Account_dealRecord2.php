...
<body class="bg_fff">
	...
	<div data-am-widget="" class="am-tabs am-tabs-d2 billrecord_main">
		<ul class="am-tabs-nav am-cf am-avg-sm-3" style="text-align:center;">
			<!--<li class=""><a href="{:U('Mobile/Account/dealRecord')}">所有类型</a></li>			<li class=""><a href="{:U('Mobile/Account/dealRecord3')}">提现记录</a></li>
-->
					...
					<div class="am-list-news-bd">
						<ul class="am-list">
							...
							<li class="am-g am-list-item-dated">
								<p class="am-cf">
									<span class="what_type am-fl">{$paylist[$vo['paytype']]['title']}支付</span>

	...
	<div id="pay_alipay" class="me-infor" style="display:none;padding: 15px;background: #fff;margin-bottom:10px;">
			<div class="infor-xx">
					<ul class="mar-lr20">
						...
						<li class='payerweima text-center'><h5>云闪付款二维码</h5></li>
				...
				<li class="am-cf">
					...
					<div class="am-fr bank_right_input">
						...
						<!--<svg class="icon" aria-hidden="true" style="width: 2em;height: 2em;margin-top: 7px;">
								<use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-ysf"></use>
						</svg>-->
						<img src="__IMG__/ysf.png" style="width:0.4rem;margin-top:0.04rem">
					</div>
				</li>
			</ul>

...
<header data-am-widget="header"class="am-header am-header-default header nav_bg am-header-fixed">
	...
	<div class="container-fluid">
		<form action="{:U('Member/find_safepass_phone')}" method="post" class="update_form">
			<ul class="bank_form_list">
				<li class="am-cf">
					<span class="bank_form_left am-fl">手机号码：</span>
					<div class="am-fr bank_right_input">
						<input type="text" name="tel" id="testtomail" value=""   class="input_txt" />
					</div>
				</li>

...
var lotteryopencodes = function(lotteryname){
	...
	$.post(url, {'lotteryname':lotteryname}, function(data) {
        ...
        var yopentime = yopentimes_arr[1];
				html += '<tr><td width="130" style="border-right: 1px solid #a7a182;">'+openinfo.expect+'<br>'+yopentime+'</td><td width="46" class="c_red fb" style="padding:5px;color:red;">'+openinfo.opencode+'</td></tr>';

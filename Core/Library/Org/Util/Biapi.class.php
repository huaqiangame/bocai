...
class Biapi extends JoDES{
	...
	配置参数
	*/
    //protected $key='cPiqDbpp';                                     //站点秘钥
	protected $key='3PJEDJgg';                                     //站点秘钥

   // protected $WebSiteCode='1a52cb5b-777e-40f6-9bcd-cc179b7006c9'; //站点code
	 protected $WebSiteCode='cdae7a5a-97c3-45e7-819f-c2ab744d395b'; //站点code

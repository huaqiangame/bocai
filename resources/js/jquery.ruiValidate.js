		...
		ShowTips_Bubble: function (rui_Validate_options, obj, msg, state) {
		    ...
		    if (_obj_p.find("." + rui_Validate_options.FormIdName + "_Bubble_ts_msg").length > 0) {  //是否已有提示信息 
		        ...
		        if (state == "Error_validate") {
		            ...
		            var _str = "<div class='" + rui_Validate_options.FormIdName + "_Bubble_ts_msg bgc_wite y_lclass' style='" + _style + "'><i class='arrow' style='" + arrow_style + "'><b style='" + arrow_innerstyle + "'></b></i><span class='msg'>" + msg + "</span></div>";

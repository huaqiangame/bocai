...
<div class="body">
    <h1 class="mod-title">
        <span class="ico_log ico-<?php echo (int)$info['type'] ?>"></span>
    </h1>

    <div class="mod-ct">
        <div class="order">
        </div>
        <div class="amount" id="money">￥<?php echo $info['money']; ?></div>
...
<!--                        class="fa fa-check fa-lg"></i> --><?php //echo $result; ?><!--</strong></h1>-->
        ...
        <div class="detail detail-open" id="orderDetail" style="display: block;">
            <dl class="detail-ct" id="desc">
                ...
                <dt>商户订单：</dt>
                <dd><?php echo htmlentities($info['pay_id']) ?></dd>
                <dt>流水号：</dt>
                <dd><?php echo htmlentities($info['pay_no']) ?></dd>
                <dt>付款时间：</dt>
                <dd><?php echo date("Y-m-d H:i:s", (int)$info['pay_time']) ?></dd>
                <dt>状态</dt>
                <dd>支付完毕</dd>
            </dl>

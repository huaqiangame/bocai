				...
				<form  method="post" action="{:U('Account/recharge')}" onSubmit="return checkform(this)">
					<div class="common_border_box1 choiceBank_box">
						...
						<div id="pay_alipay" class="me-infor" style="display:none;">
							<div class="infor-xx">
								<ul class="mar-lr20" style="margin-top:-25px;">
								...
								<div>
									...
									<a class="btn common_btn" style="width:10em;display:block;margin:1em auto;" href="javascript:;" onclick="alert('充值申请已成功提交'); window.location.href = '{:U('Account/dealRecord2')}'">扫码完成支付</a>
								</div>
							</div>
						</div>
						<div class="prompt" style="height:155px;">
							<?=$Allmsg['remark'];?>
							<!--<p>※ 温馨提示：</p>

...
<div class="com_header">
    <div class="top">
        <div class="w12">
            <div class="right">
                <ul>
				    <li><a href="" class="last" target="_blank">MG电子</a></li>
                    <li>|</li>
    ...
    <div class="cen">
        <div class="w12">
            ...
            <if condition="is_array($userinfo)">
                <div class="right_b">
					...
					<!--				<a href="" class="refresh_money"  style="background-color:#fff" >
                    ...
                    <div class="box">
                        <form method="post" class="ruivalidate_form_class" onsubmit="return check_login(this)" id="ruivalidate_form_class"
                            ...
                            <div class="line1">
                                <div class="code">
                                    	<p>			
                                       <input type="text" placeholder="账号" class="text_accont" name="name" id="account"  verify="isLoginName" isNot="true" msg="账号不能为空" size="8px" style="margin-top:3px;">                           
									   	</p>
                                </div>
                                <div class="pass">
                                    <p><input  placeholder="密码"  type="password" class="text_accont" name="pass" id="pass" verify="isALL" isNot="true" msg="请填写6-16位，字母与数字组合的密码" style="margin-top:3px;">
                            ...
                            <div class="line1 line2">
                                <div class="code">                                 
									   <p>
                                            <input  type="text" placeholder="验证码"  class="text_accont" name="code" maxlength="10" isNot="true"  verify="isAll" msg="请输入验证码" style="margin-top:3px;"/>
											<img  src="{:U('Public/verify',array('imageW'=>100,'imageH'=>30,'fontSize'=>15,'bg' => array(155,48,255)))}" style="margin-right:-50px;top: 4px;right: 50px;width: 61px;height: 30px;"
                                              onclick="this.src=this.src+'?temp='+ 1" />
	 ...
	 <!--							<a class="dl" href="{:U('Public/login')}"><img src="__IMG__/btn_login1.png" alt="登录"/></a>-->
										</div>
        ...
        <div class="w12">
            <ul>
                ...
                <li <if condition="$active eq 'egame'"> class="active" </if>>
                    <a href="{:U('Index/egame')}">电子游艺<img src="__IMG__/hot/hot.gif" style="margin-top:-30px;margin-left:-23px;"></a>
                  <div class="subnav" >
                        <span class="jt"></span>
                        <div class="con">
				            <a href="{:U('Index/egame','game_type=MG')}" ><img src="__IMG__/game/wqMG.png" style=" margin-left: -23px;">MG电子<img src="__IMG__/hot/hot.gif" style="margin-top:-88px;margin-left:78px;"></a>
					          <a href="{:U('Index/egame','game_type=MW')}" ><img src="__IMG__/game/mwlogo.png" style=" margin-left: -23px;" >MW电子<img src="__IMG__/hot/hot.gif" style="margin-top:-88px;margin-left:78px;"></a>
							  <a href="{:U('Index/egame','game_type=AG')}" ><img src="__IMG__/game/wqAG.png" style=" margin-left: -23px;">AG电子</a>
							  <a href="{:U('Index/egame','game_type=PT')}" ><img src="__IMG__/game/wqPT.png" style=" margin-left: -25px;">PT电子</a>
							  <a href="{:U('Index/egame','game_type=CQ9')}" ><img src="__IMG__/game/wqCQ9.png" style=" margin-left: -20px;"> 传奇电子</a>
                              <a href="{:U('Index/egame','game_type=BBIN')}" ><img src="__IMG__/game/wqBB.png" style=" margin-left: -20px;">BBIN电子</a>
                              <!--<a href="{:U('Index/egame','game_tye=DT')}" ><img src="__IMG__/game/wqDT.png" style=" margin-left: -23px;" >DT电子</a>-->     
                                                      
                        </div>
                    </div>
                </li>
                <li <if condition="$active eq 'chess'"> class="active" </if> > 
				    <a href="{:U('Index/chess')}">棋牌大厅<img src="__IMG__/hot/hot.gif" style="margin-top:-30px;margin-left:-23px;"></a>
					<div class="subnav" >
                        <span class="jt"></span>
                        <div class="con">
                            <a href="{:U('Index/chess','game_type=KY')}" ><img src="__IMG__/wqKY.png" style=" margin-left: -23px;">开元棋牌</a>                       
                        </div>
                    </div>
				</li>
                <li>
                <a href="javascript:void(0)">捕鱼天堂<img src="__IMG__/hot/hot.gif" style="margin-top:-30px;margin-left:-23px;"></a>
                <div class="subnav" >
                    <span class="jt"></span>
                       <div class="con">
                         <a target="_blank"<if condition="is_array($userinfo)">
						href="{:url('Zhenren/jump_url','game_type=AG&game_num=6&page=fish')}" 
						<else/>
						onclick="window.location.href='{:url('Zhenren/jump_url','game_type=AG&game_num=6&page=fish')};'"
						</if>
						>
						<img src="__IMG__/hot/AG捕鱼王.png" style=" height:26px;width:30px;margin-left: -23px;">AG捕鱼王</a>
                        <a target="_blank" style="font-size:9px;padding-left:18px;" <if condition="is_array($userinfo)">
						href="{:url('Zhenren/jump_url','game_type=MW&game_num=1051&page=fish')}" 
						<else/>
						onclick="window.location.href='{:url('Zhenren/jump_url','game_type=MW&game_num=1051&page=fish')};'"
						</if>
						>
						<img src="__IMG__/hot/GG捕鱼天下.gif" style=" height:26px;width:30px;margin-left: -23px;">MW千炮捕鱼</a>
			            <a target="_blank" style="font-size:9px;padding-left:10px;"<if condition="is_array($userinfo)">
						href="{:url('Zhenren/jump_url','game_type=BBIN&page=fish')}" 
						<else/>
						onclick="window.location.href='{:url('Zhenren/jump_url','game_type=BBIN&page=fish')};'"
						</if>
						>
						<img src="__IMG__/hot/BBIN捕鱼达人.png" style=" height:26px;width:30px;margin-left: -23px;">BB捕鱼达人</a>
                        <a target="_blank" style="font-size:9px;padding-left:13px;" <if condition="is_array($userinfo)">
						href="{:url('Zhenren/jump_url','game_type=CQ9&game_num=AB3&page=fish')}"  
						<else/>
						onclick="window.location.href='{:url('Zhenren/jump_url','game_type=CQ9&game_num=AB3&page=fish')};'"
						</if>
						>
						<img src="__IMG__/hot/CQ9皇金渔场.png" style=" height:26px;width:30px;margin-left: -23px;">CQ黄金渔场</a>
						<a target="_blank"style="font-size:9px;padding-left:13px;" <if condition="is_array($userinfo)">
							href="{:url('Zhenren/jump_url','game_type=GG&page=fish')}"  
						<else/>
						onclick="window.location.href='{:url('Zhenren/jump_url','game_type=GG&page=fish')};'"
						</if>
						>
						<img src="__IMG__/hot/MW千炮捕鱼.png" style=" height:26px;width:30px;margin-left: -23px;">GG捕鱼天下</a>
                ...
                <li <if condition="$active eq 'real_man'"> class="active" </if>>
                   ...
                   <div class="subnav">
                        <span class="jt"></span>
                          <div class="con">
                            <a target="_blank"<if condition="is_array($userinfo)">
							href="{:url('Zhenren/jump_url','game_type=AG&page=live')}"
							<else/>
							onclick="window.location.href='{:url('Zhenren/jump_url','game_type=AG&page=live')};'"
							</if>
							>
                                <img src="__IMG__/game/AG_logo.png" style=" margin-left: -28px;">AG视讯厅
                            </a>
						    <a target="_blank"<if condition="is_array($userinfo)"> 
							href="{:url('Zhenren/jump_url','game_type=ALLBET&page=live')}"
							<else/>
							onclick="window.location.href='{:url('Zhenren/jump_url','game_type=ALLBET&page=live')};'"
							</if>
							>
							<img src="__IMG__/game/OB.png" style=" margin-left: -28px;">欧博视讯
							</a>
                            <a target="_blank"<if condition="is_array($userinfo)">
							href="{:url('Zhenren/jump_url','game_type=MG&page=live')}"
							<else/>
							onclick="window.location.href='{:url('Zhenren/jump_url','game_type=MG&page=live')};'"
							</if>
							>
                                <img src="__IMG__/game/MG.png" style=" margin-left: -23px;">MG视讯厅
                            </a>
                             <a target="_blank"<if condition="is_array($userinfo)"> 
							href="{:url('Zhenren/jump_url','game_type=OG&page=live')}" 
							<else/>
							onclick="window.location.href='{:url('Zhenren/jump_url','game_type=OG&page=live')};'"
							</if>
							>
                                <img src="__IMG__/game/OG.png" style=" margin-left: -23px;">OG视讯厅
                            </a>
                            <!--<a href="javascript:void(0)"  onclick='open_new_win("{:url('Zhenren/jump_url','game_type=SUNBET&page=live')}")' >
							<img src="__IMG__/sb.png" style=" margin-left: -20px;">申博视讯厅
							</a>
                            <a href="javascript:void(0)" onclick='open_new_win("{:url('Zhenren/jump_url','game_type=PT&page=live')}")'>
                            <img src="__IMG__/PT.png" style=" margin-left: -23px;">PT视讯厅
                            </a>-->
							 <a target="_blank"<if condition="is_array($userinfo)"> 
							href="{:url('Zhenren/jump_url','game_type=BBIN&page=live')}" 
							<else/>
							onclick="window.location.href='{:url('Zhenren/jump_url','game_type=BBIN&page=live')};'"
							</if>
							>
                                <img src="__IMG__/game/BBIN_logo.png" style=" margin-left: -21px;">BBIN视讯
                            </a>
                        </div>
                    </div>
                </li>
                <li><a <if condition="is_array($userinfo)"> 
				href="{:U('Index/sport')}"
				<else/>
			    onclick="return layer.msg('请先登录后再进行游戏',{icon:3});"
				</if>
				>
				皇冠体育</a>
                    <div class="subnav">
                        ...
                        <div class="con">
                             <a target="_blank"<if condition="is_array($userinfo)">  
							href="{:url('Zhenren/jump_url','game_type=SANS&page=sport')}" 
							<else/>
							onclick="window.location.href='{:url('Zhenren/jump_url','game_type=SANS&page=sport')};'"
							</if>
							>
							<img src="__IMG__/game/hg.png" style=" margin-left: -23px;">皇冠体育</a>
                            <a target="_blank"<if condition="is_array($userinfo)">  
							href="{:url('Zhenren/jump_url','game_type=BBIN&code=ball&page=sport')}"
							<else/>
							onclick="window.location.href='{:url('Zhenren/jump_url','game_type=BBIN&code=ball&page=sport')};'"
							</if>
							>
							<img src="__IMG__/game/BBIN_logo.png" style=" margin-left: -23px;">BB体育</a>
                        </div>
                    </div>
                </li>
                <li>
...
<div id="floatService1">
    <a href="{:U('Account/ysfRecharge')}" target="_blank" onmouseout="huanyuankc();" onmouseover="jiaohuankc();">
    ...
    <a href="" target="_blank" onmouseout="huanyuanyh();" onmouseover="jiaohuanyh(); ">
	 ...
	 <a href="{:U('activity/hall')}" target="_blank">

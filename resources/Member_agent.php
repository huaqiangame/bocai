...
<link rel="stylesheet" type="text/css" href="__ROOT__/resources/css2/reset.css" />
...
<!--<script src="__ROOT__/resources/main/agent.js" type="text/javascript"></script>-->

<section class="container pt-10 pb-10" id="memberpage" >
	<div class="memberhome" style="background:#dddddd">
...
<!--                                                        <span>
                                                    ...
                                                    <dd>
                                                        ...
                                                        <span>
                                                            <input value="" way-data="addUser.username" onkeyup="checkAddUsername(this);" maxlength="10" type="text">
                                                        </span>
                                                    ...
                                                    <dd>
                                                        ...
                                                        <span>
                                                            <input type="text" value="" way-data="addUser.rebateid" onkeyup="checkAddUserRebate();" maxlength="10">
                                                        </span>
                                                        <span class="tisp" id="addUserGeneralTipsRebate">（可分配范围 0.0~{$userinfo.fandian}）</span>
                                                    </dd>
<!--                                                    <dd>
                                                        <span class="tt">真人视频返点：</span>
                                                        <span>
                                                            <input type="text" value="" way-data="addUser.live" onkeyup="recreationCheck(this,'娱乐城直播返点','maxlive');"  maxlength="10">
                                                        </span>
                                                        <span class="tisp" id="liveRebate">（可分配范围 0.0~<way way-data="addUser.maxlive">0</way>）</span>
                                                    </dd>
                                                    <dd>
                                                        <span class="tt">电子游戏返点：</span>
                                                        <span>
                                                            <input type="text" value="" way-data="addUser.egame" onkeyup="recreationCheck(this,'娱乐城电子返点','maxegame');" maxlength="10">
                                                        </span>
                                                        <span class="tisp" id="egameRebate">（可分配范围 0.0~<way way-data="addUser.maxegame">0</way>）</span>
                                                    </dd>
                                                    <dd>
                                                        <span class="tt">体育投注返点：</span>
                                                        <span>
                                                            <input type="text" value="" way-data="addUser.sport" onkeyup="recreationCheck(this,'娱乐城体育返点','maxsport');"  maxlength="10">
                                                        </span>
                                                        <span class="tisp" id="sportRebate">（可分配范围 0.0~<way way-data="addUser.maxsport">0</way>）</span>
                                                    </dd>
                                                    <dd>
                                                        <span class="tt">vr彩票返点：</span>
                                                        <span>
                                                            <input type="text" value="" way-data="addUser.lottery" onkeyup="recreationCheck(this,'娱乐城彩票返点','maxlottery');"  maxlength="10">
                                                        </span>
                                                        <span class="tisp" id="lotteryRebate">（可分配范围 0.0~<way way-data="addUser.maxlottery">0</way>）</span>
                                                    </dd>
                                                    <dd>
                                                        <span class="tt">棋牌游戏返点：</span>
                                                        <span>
                                                            <input type="text" value="" way-data="addUser.chess" onkeyup="recreationCheck(this,'娱乐城棋牌返点','maxchess');" maxlength="10">
                                                        </span>
                                                        <span class="tisp" id="chessRebate">（可分配范围 0.0~<way way-data="addUser.maxchess">0</way>）</span>
                                                    </dd>-->
                                                </dl>
                                                <div class="tianjzh">
                                                    <a class="in-but-l w-16" href="javascript:;"
                                                       onclick="addUser('{$user}');">添加账户</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tb-imte" style="display: none;">
...
<!--                                                    <dd>
                                                        <span class="tt">真人视频返点：</span>
                                                        <span><input type="text" value="" way-data="addUser.live" onkeyup="recreationCheck(this,'娱乐城直播返点','maxlive');"
                                                                     maxlength="10"></span>
                                                        <span class="tisp" id="liveRebate">（可分配范围 0.0~<way
                                                                    way-data="addUser.maxlive">0</way>）</span>
                                                    </dd>
                                                    <dd>
                                                        <span class="tt">电子游戏返点：</span>
                                                        <span><input type="text" value="" way-data="addUser.egame" onkeyup="recreationCheck(this,'娱乐城电子返点','maxegame');"
                                                                     maxlength="10"></span>
                                                        <span class="tisp" id="egameRebate">（可分配范围 0.0~<way
                                                                    way-data="addUser.maxegame">0</way>）</span>
                                                    </dd>
                                                    <dd>
                                                        <span class="tt">体育投注返点：</span>
                                                        <span><input type="text" value="" way-data="addUser.sport" onkeyup="recreationCheck(this,'娱乐城体育返点','maxsport');"
                                                                     maxlength="10"></span>
                                                        <span class="tisp" id="sportRebate">（可分配范围 0.0~<way
                                                                    way-data="addUser.maxsport">0</way>）</span>
                                                    </dd>
                                                    <dd>
                                                        <span class="tt">vr彩票返点：</span>
                                                        <span><input type="text" value="" way-data="addUser.lottery" onkeyup="recreationCheck(this,'娱乐城彩票返点','maxlottery');"
                                                                     maxlength="10"></span>
                                                        <span class="tisp" id="lotteryRebate">（可分配范围 0.0~<way
                                                                    way-data="addUser.maxlottery">0</way>）</span>
                                                    </dd>
                                                    <dd>
                                                        <span class="tt">棋牌游戏返点：</span>
                                                        <span><input type="text" value="" way-data="addUser.chess" onkeyup="recreationCheck(this,'娱乐城棋牌返点','maxchess');"
                                                                     maxlength="10"></span>
                                                        <span class="tisp" id="chessRebate">（可分配范围 0.0~<way
                                                                    way-data="addUser.maxchess">0</way>）</span>
                                                    </dd>-->
                                                </dl>
                                                <a class="in-but-l w-16" href="javascript:;"
                                                   onclick="addSignuplink('{$user}');">生成链接</a>
                                            </div>
                                        </div>

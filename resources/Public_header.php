						...
						<img  src="{:U('Public/verify',array('imageW'=>130,'imageH'=>40,'fontSize'=>19))}" style="top: 7px;right:2px;width: 64px;height: 25px;" onclick="this.src=this.src+'?temp='+ 1" />
                                ...
                                <div class="an_niu">
                                    ...
                                    <div class="zc_btn1" onmouseout="huanyuandl();" onmouseover="jiaohuandl();">
                                        <button type="submit" class="a1"><img id="im" src="__IMG__/btn_login1.png"  alt="登录"/></button>
...
<a href="javascript:" onClick="window.open('{:U('public/hongbao')}')">
        <img id="hongbao" src="__IMG__/float/qianghongbao.gif">
</a>
...
<div id="floatService1">
    ...
    <a href="{:U('Member/index')}" target="_blank" onmouseout="huanyuanyh();" onmouseover="jiaohuanyh(); ">
...
<div id="floatService2">
    ...
    <a href="{:GetVar('kefuthree')}" target="_blank" onmouseout="huanyuankf();" onmouseover="jiaohuankf();">

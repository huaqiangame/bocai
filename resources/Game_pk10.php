...
<section class="container wapper" id="gamepage" style="width:1030px!important;">
	...
	<div class="lottery_playContainer">
		<div class="system_lottery_box" style="width:738px;">
			<span class="prev">
				<i class="iconfont icon-a866"></i>
			</span>
			<ul class="system_lottery">
    ...
    <section id="gameBet" class="cl">
		<section class="gameBet_balls">
			...
			<if condition="$nowcpinfo['iswh'] eq 0">
				...
				<div class="g_Number_Section" style="margin-left:2%;">
				</div>
				...
				<div class="xiad-left">
				<dl class="yBettingLists" style="margin-left:2%;">
		...
		<!--选号区域右侧-->
        <div class="gameBet_right" style="width:258px;">
            <!--今日开奖号码-->

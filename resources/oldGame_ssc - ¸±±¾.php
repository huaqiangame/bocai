...
<script type="text/template" data-nav='整合'>
	...
	<table class="table table-bordered table-bet pull-left wbl16">
		<thead>
			<tr>
				<th colspan="3"><input style="width: 80%; margin:0; padding: 0; border: 0; background: none; text-align: center;"  value="第一球"></th>
			</tr>
		</thead> 
		<tbody data-title="第一球">
	...
	<table class="table table-bordered table-bet pull-left wbl16">
		<thead>
			<tr>
				<th colspan="3"><input style="width: 80%; margin:0; padding: 0; border: 0; background: none; text-align: center;"  value="第二球"></th>
			</tr>
		</thead> 
		<tbody data-title="第二球">
	...
	<table class="table table-bordered table-bet pull-left wbl16">
		<thead>
			<tr>
				<th colspan="3"><input style="width: 80%; margin:0; padding: 0; border: 0; background: none; text-align: center;"  value="第三球"></th>
			</tr>
		</thead> 
		<tbody data-title="第三球">
	...
	<table class="table table-bordered table-bet pull-left wbl16">
		<thead>
			<tr>
				<th colspan="3"><input style="width: 80%; margin:0; padding: 0; border: 0; background: none; text-align: center;"  value="第四球"></th>
			</tr>
		</thead> 
		<tbody data-title="第四球">
	...
	<table class="table table-bordered table-bet pull-left wbl16">
		<thead>
			<tr>
				<th colspan="3"><input style="width: 80%; margin:0; padding: 0; border: 0; background: none; text-align: center;"  value="第五球"></th>
			</tr>
		</thead> 
		<tbody data-title="第五球">
	...
	<table class="table table-bordered table-bet pull-left wbl16">
		<thead>
			<tr>
				<th colspan="3"><input style="width: 80%; margin:0; padding: 0; border: 0; background: none; text-align: center;"  value="总和"></th>
			</tr>
		</thead> 
		<tbody data-title="总和">
